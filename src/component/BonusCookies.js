...
// import imgYolo from "../img/yolo-pizza.png";
// import imgClick from "../img/click-pizza.png";
...
export const BonusCookies = (props) => {
  ...
  const btnValueClick =
    score >= priceValueClick ? (
      ...
      >
        ...
        {/* <img src={imgYolo} width="100" height="100" /> */}
        <h4>
          {" "}
  ...
  const btnAutoClick =
    score >= priceAutoClick ? (
      ...
      >
        ...
        {/* <img src={imgClick} width="100" height="100" /> */}
        <h4>
          {" "}
          {/* <img className="imgCoin" src={imgCoin} width="20" height="20" /> */}
  ...
  >
    ...
    {/* <img src={imgExplosion} width="100" height="100" /> */}
     <h4> {/*<img className="imgCoin" src={imgCoin} width="20" height="20" />*/}Price: {priceLoloClick} pizza coin</h4> 
